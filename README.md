...
| <a name="module_storage"></a> [storage](#module\_storage) | ./create-storage | n/a |
...
| <a name="input_longhorn_version"></a> [longhorn\_version](#input\_longhorn\_version) | n/a | `string` | `"1.6.2"` | no |
